...
export default function About() {
  return (
    <div className='relative w-full h-full p-10 bg-white' id='about'>
        ...
        Dear Lord we commend the soul of Reverend Canon Felix Edematie Agbroko into your merciful hands, Trusting in your boundless love and compassion.May he find rest and solace in your presence,And may he be welcomed into the joy of your heavenly kingdom.
        Amen
        </p>

        <img src={PictureAlbum} alt="album pictures" className="w-5/6 mx-auto  lg:w-3/5"/>
        <img src={Grey} className='absolute left-0 w-44 scale-x-[-1] opacity-10 top-1/2'/>
    </div>
  )
}
