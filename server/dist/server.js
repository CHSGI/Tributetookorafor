...
app.get('/tributes', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, prisma.tribute.findMany()];
            case 1:
                tributes = _a.sent();
                res.json(tributes);
                return [3 /*break*/, 3];
...
app.post('/tributes/add', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, name, description, newTribute, error_2;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                _b.trys.push([1, 3, , 4]);
                return [4 /*yield*/, prisma.tribute.create({
                        data: {
                            name: name,
